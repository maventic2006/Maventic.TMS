...
console.log(" Creating Transporter Vehicle Config - Final Files...\n");

// ============================================
// 1. CREATE MAIN PAGE COMPONENT
// ============================================
const featureDir = path.join("frontend", "src", "features", "transporterVehicleConfig");
if (!fs.existsSync(featureDir)) {
  fs.mkdirSync(featureDir, { recursive: true });
}

const pageComponent = `import React, { useEffect, useState } from "react";
...
fs.writeFileSync(path.join(featureDir, "index.jsx"), pageComponent, "utf8");
console.log(" Created: frontend/src/features/transporterVehicleConfig/index.jsx");

console.log("\n All frontend files created successfully!");
console.log("\n Next: Update AppRoutes.jsx and navigation files manually or run update script");
