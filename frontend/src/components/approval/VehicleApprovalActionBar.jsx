...
/**
 * VehicleApprovalActionBar Component
 * Displays approval status and action buttons (Approve/Reject) for Vehicle Owner users
 * Only visible to Product Owners who did NOT create the vehicle
 */
const VehicleApprovalActionBar = ({ userApprovalStatus, vehicleId, onRefreshData }) => {
  ...
  if (!userApprovalStatus) {
    console.log("❌ VehicleApprovalActionBar: No userApprovalStatus provided");
    return null;
  }

  console.log("🔍 VehicleApprovalActionBar Debug:");
    ...
    try {
      ...
      dispatch(
        addToast({
          ...
          message: "Vehicle Owner user approved successfully",
        })
      );
      ...
      dispatch(
        addToast({
          ...
          message: error || "Failed to approve vehicle owner user",
        })
      );
    }
  };
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      dispatch(
        addToast({
          type: TOAST_TYPES.SUCCESS,
          message: "Vehicle Owner user rejected successfully",
        })
      );
      ...
      dispatch(
        addToast({
          type: TOAST_TYPES.ERROR,
          message: error || "Failed to reject vehicle owner user",
        })
      );
    }
  };
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <p className="text-sm text-gray-600">
                  Please provide a reason for rejecting this vehicle owner user. 
...
export default VehicleApprovalActionBar;
