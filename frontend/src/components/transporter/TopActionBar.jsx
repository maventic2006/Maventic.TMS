...
const TopActionBar = ({ 
  ...
  return (
    <Card className="mb-8 rounded-xl border border-gray-200 bg-white" style={{ boxShadow: '0px 2px 6px rgba(0, 0, 0, 0.05)' }}>
        ...
        <div className="flex items-center justify-between px-6 py-6 gap-4">
          ...
          <div className="flex items-center gap-4 flex-1 min-w-0">
            <Button
              ...
              size="icon"
              onClick={onBack}
              className="h-10 w-10 rounded-lg hover:bg-gray-100 hover:text-[#0D1A33] transition-all duration-200 flex-shrink-0"
            >
