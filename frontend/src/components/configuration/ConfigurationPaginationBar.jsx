...
const ConfigurationPaginationBar = ({
  ...
  return (
    <Card className="bg-gradient-to-r from-white via-gray-50 to-blue-50/30 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300 rounded-t-none border-t border-gray-200">
