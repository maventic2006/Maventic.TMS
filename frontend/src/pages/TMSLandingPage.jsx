  ...
  const menuItems = [
    {
      ...
      icon: Database,
      items: [
        { title: 'Transporter Maintenance', icon: List, description: 'View all transporters' },
        ...
        { title: 'Vehicle Maintenance', icon: Car, description: 'View all vehicles' },
        ...
        { title: 'Driver Maintenance', icon: Users, description: 'View all drivers' },
        ...
        { title: 'Consignor Maintenance', icon: Building2, description: 'View all consignors' },
        ...
        { title: 'Consignor WH Maintenance', icon: MapPin, description: 'View warehouses' },
            ...
            <div className="flex justify-between items-center h-14">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-black font-semibold hidden lg:block leading-none">Transportation Management System</p>
                </div>
              </div>
              ...
              {menuItems.map((menu) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <Icon className={`h-4 w-4 transition-all duration-300 flex-shrink-0 ${isHovered ? 'text-primary-accent' : 'text-white'}`} />
                      <span className="whitespace-nowrap hidden lg:inline text-xs font-medium">
                        {menu.title.length > 16 ? `${menu.title.substring(0, 13)}...` : menu.title}
                      </span>
                      <ChevronDown 
                        className={`h-3 w-3 transition-all duration-300 flex-shrink-0 ${
                          isHovered ? 'rotate-180 text-primary-accent' : 'text-white'
                        }`} 
                      />
                    </button>
                  </div>
            ...
            >
              <div className="px-4 py-3 space-y-2">
                {menuItems.map((menu) => {
                  const Icon = menu.icon;
                  return (
                    <div key={menu.id} className="border-b border-slate-700 last:border-b-0 pb-2 last:pb-0">
          ...
          <div className="text-center">
            ...
            >
              ...
              {!user && (
                ...
                >
                  <div className="text-center">
                    <h3 className="text-lg font-semibold text-blue-800 mb-2">Demo Access</h3>
                    <p className="text-blue-600 text-sm mb-3">
                      Login to access all features including Transporter Maintenance
                    </p>
                    <div className="bg-white rounded-lg p-3 text-sm">
                      <div className="font-medium text-gray-700">Test Credentials:</div>
                      <div className="text-gray-600">
                        <span className="font-mono bg-gray-100 px-2 py-1 rounded mr-2">test1</span>
                        /
                        <span className="font-mono bg-gray-100 px-2 py-1 rounded ml-2">test456</span>
                      </div>
                    </div>
                  </div>
                </motion.div>
