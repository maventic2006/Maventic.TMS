  ...
  const fetchTransporterDetails = async () => {
      try {
        ...
        if (response.data && response.data.success && response.data.data) {
          ...
          console.log('✅ Extracted transporter data from nested structure:', transporterData);
          ...
          console.log('⚠️ Using direct response data (fallback):', transporterData);
        } else {
        ...
        setError(err.response?.data?.message || err.message || 'Failed to load transporter details');
      } finally {
        setLoading(false);
      }
    // };
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center min-h-[60vh]">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-text-primary mb-2">Loading Details</h3>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center min-h-[60vh]">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-text-primary mb-2">Unable to Load Data</h3>
              <p className="text-text-secondary text-sm mb-4">We encountered an issue loading the transporter information.</p>
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-text-primary">Transporter Details</h1>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-xl font-semibold text-text-primary mb-1">
                    {transporter?.businessName || transporter?.business_name || 'Business Name Not Available'}
                  </h2>
                  <p className="text-sm text-text-secondary">Transportation & Logistics</p>
                </div>
                <div className="text-right">
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                    ...
                    <div className={`w-2 h-2 rounded-full mr-2 ${
                      transporter?.status === 'Active' ? 'bg-green-500' 
                      : transporter?.status === 'Pending' ? 'bg-yellow-500'
                      : 'bg-red-500'
                    }`}></div>
