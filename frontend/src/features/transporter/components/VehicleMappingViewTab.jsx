...
import { fetchVehicleMappings } from "../../../redux/slices/transporterSlice";

const VehicleMappingViewTab = ({ transporterId }) => {
  ...
  useEffect(() => {
    if (transporterId) dispatch(fetchVehicleMappings(transporterId));
