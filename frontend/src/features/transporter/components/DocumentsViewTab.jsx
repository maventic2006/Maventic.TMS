        ...
        <div className="space-y-6">
          {documents.map((document, documentIndex) => {
            ...
            return (
              ...
              >
                {/* Document Header */}
                <div className="flex items-center justify-between border-b border-purple-200/30 pb-4 mb-6">
                  ...
                  <div
                    className={`rounded-lg p-4 ${
                      isExpired
                        ...
                        : "bg-gradient-to-r from-green-100/50 to-teal-100/50 border border-green-200"
                    }`}
                  >
                    <div className="flex items-center gap-3">
                      {isExpired ? (
          ...
          <div className="bg-gradient-to-r from-blue-50/50 to-indigo-50/50 rounded-2xl p-6 border border-blue-100/50">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Overview of all transporter documents
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 border border-gray-200/50 text-center">
                <div className="text-2xl font-bold text-green-600 mb-1">
                  {
                    documents.filter(
                      (doc) => doc.status && !isDocumentExpired(doc.validTo)
                    ).length
                  }
                </div>
                ...
                <div className="text-2xl font-bold text-yellow-600 mb-1">
                  {
                    documents.filter((doc) =>
                      isDocumentExpiringSoon(doc.validTo)
                    ).length
                  }
                </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 border border-gray-200/50 text-center">
                <div className="text-2xl font-bold text-red-600 mb-1">
                  {
                    documents.filter((doc) => isDocumentExpired(doc.validTo))
                      .length
                  }
                </div>
