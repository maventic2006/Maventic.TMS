exports.seed = async function(knex) {
  ...
  await knex('user_master').insert([
    ...
    },
    {
      ...
      alternate_mobile: '+91-8765432108',
      whatsapp_number: '+91-8765432109',
      from_date: '2024-01-01',
      to_date: '2025-12-31',
      is_active: true,
      customer_id: 'CUST002',
  ...
  await knex('message_text_language').insert([
    {
      ...
      message_master_id: 'MSG001',
      language: 'English',
      message_text: 'Your vehicle {vehicle_id} is due for service on {service_date}. Please schedule maintenance to ensure safety and compliance.',
      created_by: 'SYSTEM',
      updated_by: 'SYSTEM'
    },
    {
      ...
      message_master_id: 'MSG001',
      language: 'Hindi',
      message_text: 'आपका वाहन {vehicle_id} {service_date} को सेवा के लिए देय है। सुरक्षा और अनुपालन सुनिश्चित करने के लिए कृपया रखरखाव का समय निर्धारित करें।',
      created_by: 'SYSTEM',
      updated_by: 'SYSTEM'
    },
    {
      ...
      message_master_id: 'MSG002',
      language: 'English',
      message_text: 'Your document {document_name} will expire on {expiry_date}. Please renew it before the expiry date.',
      created_by: 'SYSTEM',
      updated_by: 'SYSTEM'
    }
  ]);
